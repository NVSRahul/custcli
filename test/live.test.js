...
test("prepareLiveConfig writes Gemini bridge tools, runtime, and agent files", async () => {
  ...
  assert.match(planToolRaw, /contradictions/)
  assert.match(planToolRaw, /previous_plan_summary/)
  assert.match(planToolRaw, /routing_context/)
  ...
  assert.match(reviewToolRaw, /compact_plan/)
  assert.match(reviewToolRaw, /contradictions/)
  assert.match(reviewToolRaw, /routing_context/)
  ...
  assert.match(bridgeRaw, /machineCheckPlan/)
  assert.match(bridgeRaw, /createLiveEvidenceGraph/)
  assert.match(bridgeRaw, /buildContradictions/)
  assert.match(bridgeRaw, /computeRoutingDecision/)
  assert.match(bridgeRaw, /compilePromotions/)
  assert.match(bridgeRaw, /buildMemoryTiers/)
  assert.match(bridgeRaw, /normalizeContradictionInput/)
  assert.match(bridgeRaw, /normalizeCompactPlanInput/)
  ...
  assert.match(bridgeRaw, /plan-compact\.json/)
  assert.match(bridgeRaw, /plan-validation\.json/)
  assert.match(bridgeRaw, /review-compact\.json/)
  assert.match(bridgeRaw, /evidence-graph\.json/)
  assert.match(bridgeRaw, /evidence-compact\.json/)
  assert.match(bridgeRaw, /contradictions-compact\.json/)
  assert.match(bridgeRaw, /promotions\.json/)
  assert.match(bridgeRaw, /memory-hot\.json/)
  assert.match(bridgeRaw, /memory-learned\.json/)
  assert.match(agentsMdRaw, /plan-compact\.json/)
  assert.match(agentsMdRaw, /contradictions-compact\.json/)
  assert.match(agentRaw, /plan-compact\.json/)
  assert.match(agentRaw, /evidence-compact\.json/)
})
