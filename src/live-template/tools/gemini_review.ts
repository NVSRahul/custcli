...
export default tool({
  description:
    "Ask Gemini CLI to review the current implementation or answer for correctness, risk, and plan fidelity, save the full artifacts to disk, and return only a compact review synthesis for internal use.",
  args: {
